...
- **Scheduled Week Calculation:** ISO 8601 week auto-computed from meeting scheduled dates
...
A: Balance. One level is too flat for large projects; three levels becomes folder-hell. Two levels = just right.
...
A: Notes remain attached and visible in audit history. When you restore the item (is_active = true), notes reappear.
...
**Document Version:** V1.0 (Harmonized with Data Models V1)
