...
3. **Native Livewire preference** - Use native Livewire components; Flux UI only when absolutely necessary
...
**Repository Pattern in Livewire:**
...
class RiskList extends Component
{
    ...
    public function render()
    {
        ...
        $risks = $this->riskRepository->getAllByProject(
            $this->projectId,
...
$risks = $this->riskRepository->getAllByProject($projectId);
...
class ViewRisk extends Component
{
    ...
    public function render()
    {
        $risk = $this->riskRepository->findByProjectAndId(
...
class RiskController extends Controller
{
    ...
    {
        $risk = $this->riskRepository->findByProjectAndId($projectId, $riskId);
...
{
    public function getAllByProject(
        int $projectId,
        array $with = [],
        int $paginate = 50,
        array $filters = []
    ...
    public function findByProjectAndId(
        int $projectId,
        int $id,
        array $with = []
    ): Risk {
...
public function getAllByProject(int $projectId, array $with = [])
{
    $query = Risk::where('project_id', $projectId);
